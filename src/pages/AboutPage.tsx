...
const ABOUT_TEXT: Record<UiLanguage, AboutText> = {
  ...
  fr: {
    ...
    kicker: 'À propos',
    description:
      'Bee Around transforme les données ouvertes de biodiversité de GBIF en portraits de lieux ludiques et partageables. Choisissez un lieu, actualisez pour obtenir un nouvel angle, verrouillez vos cartes préférées et exportez une affiche pour la médiation, l\'éducation ou la découverte rapide.',
    docLinksAria: 'Liens de documentation détaillés',
    howItWorks: 'Fonctionnement',
    dataNotes: 'Notes sur les données',
    posterIngredientsAria: 'Ingrédients de l\'affiche',
    posterIngredients: ['Observations sur GBIF', 'Portrait de biodiversité', 'Données de GBIF'],
    teamAria: 'Équipe du projet',
    developerCardAria: 'Carte développeur',
    designerCardAria: 'Carte designer',
    developer: 'Développeur',
    designer: 'Designer',
    area: {
      title: 'Quelle zone l\'affiche couvre-t-elle ?',
      p1: 'La recherche de lieu vient d\'OpenStreetMap Nominatim. Bee Around conserve le libellé choisi, le point central, le code pays et la boîte englobante.',
      p2: 'Les requêtes GBIF privilégient cette boîte englobante. Si elle n\'existe pas, l\'app crée un rectangle avec le rayon de secours. Les très grandes boîtes utilisent country=XX quand c\'est possible.',
      flowAria: 'Flux de sélection de zone',
      flow: ['Recherche de lieu', 'Boîte englobante', 'Données GBIF'],
      mapAria: 'Schéma de zone par boîte englobante',
      mapLabel: 'zone choisie',
    },
    data: {
      title: 'Quelles données GBIF sont résumées ?',
      p1: 'L\'affiche demande à GBIF des facettes compactes d\'occurrences avec limit=0. Cela donne des totaux et des résumés groupés sans télécharger chaque occurrence.',
      p2: 'La requête principale groupe par mois, année, jeu de données, règne et type de preuve. De plus petites requêtes construisent les listes candidates pour les espèces, la conservation et les thèmes.',
      queryAria: 'Schéma de requête de résumé GBIF',
      countFacets: 'total + facettes',
      arrow: 'les facettes deviennent des cartes',
      signals: ['Mois', 'Année', 'Règne', 'Jeu de données', 'Type de preuve'],
    },
    species: {
      title: 'Comment les espèces sont-elles choisies ?',
      p1: 'Les espèces mises en avant viennent de grands emplacements taxonomiques. Chaque emplacement demande à GBIF les espèces locales les plus enregistrées dans cette classe ou ce règne.',
      p2: 'Bee Around garde un petit groupe de tête, retire les candidats faiblement représentés, puis utilise la graine de l\'affiche pour choisir un mélange reproductible.',
      groups: ['Mammifère', 'Oiseau', 'Insecte', 'Plante à fleurs', 'Arbre ou fougère', 'Champignon'],
      arrow: 'meilleurs candidats locaux',
      boardAria: 'Schéma de sélection des emplacements d\'espèces',
      boardLabels: ['Oiseau', 'Insecte', 'Plante'],
    },
    labels: {
      title: 'Que signifient les étiquettes de l\'affiche ?',
      season: 'De saison - juin',
      seasonDescription: 'Tirée des espèces les plus enregistrées pendant le mois calendaire courant.',
      small: 'Petite merveille',
      smallDescription: 'Tirée des principaux candidats locaux chez les insectes et les champignons.',
      night: 'Créature nocturne',
      nightDescription: 'Tirée des principaux candidats locaux parmi chauves-souris, hiboux, papillons de nuit, lucioles et groupes proches.',
      risk: 'Menacé - CR',
      riskDescription: 'Choisi parmi les principales espèces locales du niveau de risque IUCN le plus élevé disponible.',
      signature: 'Signature - 12x',
      signatureDescription: 'Choisi parmi les espèces dont la part GBIF locale est élevée par rapport à la base mondiale.',
    },
    photos: {
      title: 'Comment les photos sont-elles choisies ?',
      p1: 'L\'identité de l\'espèce est d\'abord choisie depuis les données GBIF. Les images sont une couche de secours ajoutée ensuite au mieux.',
      p2: 'Les sources sont essayées par ordre de priorité. Si aucune image n\'est trouvée, l\'espèce reste et la carte utilise un emplacement réservé.',
      fallbackAria: 'Priorité de secours des photos',
      steps: ['Correspondance exacte iNaturalist', 'Clé GBIF Wikidata / Commons', 'Médias d\'espèce GBIF'],
      firstMatchWins: 'la première correspondance gagne',
    },
    comparison: {
      title: 'Comment fonctionne la comparaison ?',
      p1: 'Un notebook résout des villes et pays sélectionnés, puis interroge les facettes GBIF pour chaque boîte englobante.',
      p2: 'Il calcule la surface, la densité de données, la part menacée et le nombre d\'espèces uniques, puis classe les lignes dans les cohortes ville ou pays. L\'app embarque le fichier léger de percentiles.',
      flowAria: 'Flux de pré-calcul',
    ...
    regenerate: {
      title: 'Pourquoi Régénérer reste-t-il reproductible ?',
      p1: 'Chaque affiche a une graine. Régénérer change la graine, ce qui fait tourner les candidats éligibles et les positions de cartes non verrouillées.',
      p2: 'Les espèces sont dédoublonnées entre les cartes, et les liens partagés stockent le lieu, la graine, le thème, la langue et les verrouillages.',
      seed1: 'Graine 1',
      seed2: 'Graine 2',
      shareUrl: 'URL de partage',
    },
    credits: {
      title: 'D\'où viennent les crédits ?',
      p: 'Les noms d\'espèces, la taxonomie, les totaux d\'occurrences, les métadonnées de jeux de données et les liens d\'espèces GBIF viennent de GBIF. Les crédits photo et licences sont affichés quand la source d\'image les fournit.',
      dataAndAttribution: 'Données et attribution',
    },
  },
  es: {
    back: 'Volver',
    kicker: 'Acerca de',
    description:
      'Bee Around convierte registros abiertos de biodiversidad de GBIF en retratos de lugares juguetones y compartibles. Elige un lugar, actualiza para obtener una nueva mirada, bloquea tus tarjetas favoritas y exporta un póster para divulgación, educación o descubrimiento rápido.',
    docLinksAria: 'Enlaces de documentación detallada',
    howItWorks: 'Cómo funciona',
    dataNotes: 'Notas de datos',
    posterIngredientsAria: 'Ingredientes del póster',
    ...
    designerCardAria: 'Tarjeta de diseñador',
    developer: 'Desarrollador',
    designer: 'Diseñador',
    area: {
      title: '¿De qué área trata el póster?',
      p1: 'La búsqueda de lugares viene de OpenStreetMap Nominatim. Bee Around conserva la etiqueta seleccionada, el punto central, el código de país y el cuadro delimitador.',
      p2: 'Las consultas a GBIF prefieren ese cuadro delimitador. Si no existe, la app crea un rectángulo con el radio de respaldo. Los cuadros muy grandes usan country=XX cuando es posible.',
      flowAria: 'Flujo de selección de área',
      flow: ['Búsqueda de lugar', 'Cuadro delimitador', 'Registros GBIF'],
      mapAria: 'Boceto del área del cuadro delimitador',
      mapLabel: 'área seleccionada',
    },
    data: {
      title: '¿Qué datos de GBIF se resumen?',
      p1: 'El póster pide a GBIF facetas compactas de ocurrencias con limit=0. Eso da conteos y resúmenes agrupados sin descargar todos los registros.',
      p2: 'La consulta principal agrupa por mes, año, conjunto de datos, reino y tipo de evidencia. Consultas más pequeñas crean grupos candidatos de especies, conservación y temas.',
      queryAria: 'Boceto de consulta resumida de GBIF',
      countFacets: 'conteo + facetas',
      arrow: 'las facetas se vuelven tarjetas',
      signals: ['Mes', 'Año', 'Reino', 'Dataset', 'Tipo de evidencia'],
    },
    species: {
      title: '¿Cómo se seleccionan las especies?',
      p1: 'Las especies destacadas vienen de ranuras taxonómicas amplias. Cada ranura pide a GBIF las especies locales más registradas en esa clase o reino.',
      p2: 'Bee Around mantiene un pequeño grupo principal, elimina candidatos con poca representación y luego usa la semilla del póster para elegir una mezcla repetible.',
      groups: ['Mamífero', 'Ave', 'Insecto', 'Planta con flor', 'Árbol o helecho', 'Hongo'],
      arrow: 'principales candidatos locales',
      boardAria: 'Boceto de selección de ranuras de especies',
      boardLabels: ['Ave', 'Insecto', 'Planta'],
    },
    labels: {
      title: '¿Qué significan las etiquetas del póster?',
      season: 'En temporada - junio',
      seasonDescription: 'Sembrada desde especies principales registradas en el mes calendario actual.',
      small: 'Pequeña maravilla',
      smallDescription: 'Sembrada desde los principales candidatos locales de insectos y hongos.',
      night: 'Criatura nocturna',
      nightDescription: 'Sembrada desde murciélagos, búhos, polillas, luciérnagas y grupos relacionados locales principales.',
      risk: 'En riesgo - CR',
      riskDescription: 'Elegida entre especies locales principales en la categoría de riesgo IUCN más alta disponible.',
      signature: 'Firma - 12x',
      signatureDescription: 'Elegida entre especies cuya proporción local en GBIF es alta frente a la línea base global.',
    },
    photos: {
      title: '¿Cómo se eligen las fotos?',
      p1: 'La identidad de la especie se elige primero desde datos de GBIF. Las imágenes son una capa de respaldo de mejor esfuerzo que se agrega después.',
      p2: 'Las fuentes se prueban por orden de prioridad. Si no aparece ninguna imagen, la especie permanece y la tarjeta usa un marcador de posición.',
    ...
    comparison: {
      ...
      p1: 'Un notebook resuelve ciudades y países curados, y luego consulta facetas de GBIF para cada cuadro delimitador.',
      p2: 'Calcula área, densidad de registros, proporción amenazada y conteos de especies únicas, y después ordena filas dentro de cohortes de ciudad o país. La app incluye el archivo ligero de percentiles.',
      flowAria: 'Flujo de precálculo',
      flow: ['lugares', 'facetas', 'percentiles'],
      barsAria: 'Barras de comparación de ejemplo',
      recordingIntensity: 'Intensidad de registro',
      threatenedShare: 'Proporción amenazada',
    },
    regenerate: {
      title: '¿Por qué Regenerar sigue siendo repetible?',
      p1: 'Cada póster tiene una semilla. Regenerar cambia la semilla, rotando candidatos principales elegibles y posiciones de tarjetas desbloqueadas.',
    ...
    credits: {
      title: '¿De dónde vienen los créditos?',
      p: 'Los nombres de especies, taxonomía, conteos de ocurrencias, metadatos de datasets y enlaces de especies de GBIF vienen de GBIF. Los créditos y licencias de fotos se muestran cuando la fuente de imagen los proporciona.',
      dataAndAttribution: 'Datos y atribución',
    },
  },
  tr: {
    back: 'Geri',
  ...
  de: {
    ...
    kicker: 'Über',
    description:
      'Bee Around verwandelt offene GBIF-Biodiversitätsdaten in spielerische, teilbare Porträts von Orten. Wählen Sie einen Ort, aktualisieren Sie für eine neue Perspektive, sperren Sie Lieblingskarten und exportieren Sie ein Poster für Vermittlung, Bildung oder schnelle Entdeckung.',
    docLinksAria: 'Detaillierte Dokumentationslinks',
    howItWorks: 'So funktioniert es',
    dataNotes: 'Datennotizen',
    posterIngredientsAria: 'Poster-Bestandteile',
    posterIngredients: ['GBIF-Nachweise', 'Biodiversitätsporträt', 'Daten von GBIF'],
    ...
    area: {
      ...
      p1: 'Die Ortssuche kommt von OpenStreetMap Nominatim. Bee Around speichert das gewählte Label, den Mittelpunkt, den Ländercode und die Bounding Box.',
      p2: 'GBIF-Abfragen nutzen bevorzugt diese Bounding Box. Wenn keine existiert, erstellt die App ein Rechteck aus dem Ersatzradius. Sehr große Boxen verwenden nach Möglichkeit country=XX.',
      flowAria: 'Ablauf der Gebietsauswahl',
      flow: ['Ortssuche', 'Bounding Box', 'GBIF-Daten'],
      mapAria: 'Skizze des Bounding-Box-Gebiets',
      mapLabel: 'gewähltes Gebiet',
    },
    data: {
      ...
      p2: 'Die Hauptabfrage gruppiert nach Monat, Jahr, Datensatz, Reich und Evidenztyp. Kleinere Abfragen bilden Kandidatenpools für Arten, Schutzstatus und Themen.',
    ...
    species: {
      title: 'Wie werden Arten ausgewählt?',
      p1: 'Vorgestellte Arten stammen aus breiten taxonomischen Slots. Jeder Slot fragt GBIF nach den lokal am häufigsten erfassten Arten dieser Klasse oder dieses Reichs.',
      p2: 'Bee Around behält einen kleinen Top-Pool, entfernt schwach vertretene Kandidaten und nutzt dann den Poster-Seed für eine reproduzierbare Mischung.',
      groups: ['Säugetier', 'Vogel', 'Insekt', 'Blütenpflanze', 'Baum oder Farn', 'Pilz'],
    ...
    labels: {
      ...
      nightDescription: 'Aus lokalen Top-Kandidaten wie Fledermäusen, Eulen, Nachtfaltern, Leuchtkäfern und verwandten Gruppen gebildet.',
      risk: 'Gefährdet - CR',
      riskDescription: 'Aus lokalen Top-Arten in der höchsten verfügbaren IUCN-Risikokategorie gewählt.',
      signature: 'Signatur - 12x',
      signatureDescription: 'Aus Arten gewählt, deren lokaler GBIF-Anteil gegenüber der globalen Basis hoch ist.',
    },
    photos: {
      title: 'Wie werden Fotos ausgewählt?',
      p1: 'Die Artidentität wird zuerst aus GBIF-Daten gewählt. Bilder sind eine nachträgliche Best-Effort-Ersatzschicht.',
      p2: 'Quellen werden in Prioritätsreihenfolge versucht. Wenn kein Bild gefunden wird, bleibt die Art erhalten und die Karte nutzt einen Platzhalter.',
      fallbackAria: 'Priorität der Foto-Ersatzquellen',
    ...
    comparison: {
      ...
      p1: 'Ein Notebook löst kuratierte Städte und Länder auf und fragt dann GBIF-Facetten für jede Bounding Box ab.',
      p2: 'Es berechnet Fläche, Nachweisdichte, Anteil gefährdeter Arten und Zahlen eindeutiger Arten und rankt die Zeilen innerhalb von Stadt- oder Länderkohorten. Die App liefert die schlanke Percentile-Datei mit.',
      flowAria: 'Precompute-Workflow',
    ...
    regenerate: {
      ...
      p1: 'Jedes Poster hat einen Seed. Neu generieren ändert den Seed und rotiert geeignete Top-Kandidaten sowie nicht gesperrte Kartenpositionen.',
      p2: 'Arten werden über Karten hinweg dedupliziert, und geteilte Links speichern Ort, Seed, Theme, Sprache und Sperren.',
      seed1: 'Seed 1',
      seed2: 'Seed 2',
      shareUrl: 'Teilen-URL',
    },
  ...
  it: {
    ...
    kicker: 'Informazioni',
    description:
      'Bee Around trasforma i record aperti di biodiversità di GBIF in ritratti di luoghi giocosi e condivisibili. Scegli un luogo, aggiorna per una nuova prospettiva, blocca le schede preferite ed esporta un poster per divulgazione, educazione o scoperta rapida.',
    docLinksAria: 'Link alla documentazione dettagliata',
    howItWorks: 'Come funziona',
    dataNotes: 'Note sui dati',
    posterIngredientsAria: 'Ingredienti del poster',
    posterIngredients: ['Osservazioni su GBIF', 'Ritratto della biodiversità', 'Dati da GBIF'],
    ...
    data: {
      ...
      p2: 'La query principale raggruppa per mese, anno, dataset, regno e tipo di evidenza. Query più piccole costruiscono pool candidati per specie, conservazione e temi.',
    ...
    species: {
      ...
      p1: 'Le specie in evidenza arrivano da ampi slot tassonomici. Ogni slot chiede a GBIF le specie locali più registrate in quella classe o regno.',
    ...
    labels: {
      ...
      risk: 'A rischio - CR',
      riskDescription: 'Scelta tra le principali specie locali nella categoria di rischio IUCN più alta disponibile.',
      signature: 'Firma - 12x',
      signatureDescription: 'Scelta tra specie la cui quota GBIF locale è alta rispetto alla base globale.',
    },
    photos: {
      title: 'Come vengono scelte le foto?',
      p1: 'L\'identità della specie viene scelta prima dai dati GBIF. Le immagini sono un livello di fallback best-effort aggiunto dopo.',
      p2: 'Le fonti vengono provate in ordine di priorità. Se nessuna immagine si risolve, la specie resta e la scheda usa un segnaposto.',
      fallbackAria: 'Priorità di fallback foto',
    ...
    comparison: {
      ...
      p1: 'Un notebook risolve città e paesi curati, poi interroga le faccette GBIF per ogni bounding box.',
      p2: 'Calcola area, densità di record, quota minacciata e conteggi di specie uniche, poi classifica le righe dentro coorti di città o paese. L\'app include il file percentile leggero.',
    ...
    regenerate: {
      title: 'Perché Rigenera resta ripetibile?',
  ...
  pt: {
    ...
    kicker: 'Sobre',
    description:
      'Bee Around transforma registros abertos de biodiversidade do GBIF em retratos de lugares divertidos e compartilháveis. Escolha um lugar, atualize para uma nova lente, bloqueie cartões favoritos e exporte um pôster para divulgação, educação ou descoberta rápida.',
    docLinksAria: 'Links de documentação detalhada',
    howItWorks: 'Como funciona',
    dataNotes: 'Notas de dados',
    posterIngredientsAria: 'Ingredientes do pôster',
    posterIngredients: ['Observações no GBIF', 'Retrato da biodiversidade', 'Dados do GBIF'],
    teamAria: 'Equipe do projeto',
    developerCardAria: 'Cartão de desenvolvedor',
    designerCardAria: 'Cartão de designer',
    developer: 'Desenvolvedor',
    designer: 'Designer',
    area: {
      title: 'De que área o pôster trata?',
      p1: 'A busca de lugar vem do OpenStreetMap Nominatim. Bee Around guarda o rótulo selecionado, ponto central, código do país e caixa delimitadora.',
      p2: 'As consultas ao GBIF preferem essa caixa delimitadora. Se ela não existir, o app cria um retângulo a partir do raio de fallback. Caixas muito grandes usam country=XX quando possível.',
      flowAria: 'Fluxo de seleção de área',
      flow: ['Busca de lugar', 'Caixa delimitadora', 'Registros GBIF'],
      mapAria: 'Esboço da área da caixa delimitadora',
      mapLabel: 'área selecionada',
    },
    data: {
      title: 'Quais dados do GBIF são resumidos?',
      p1: 'O pôster pede ao GBIF facetas compactas de ocorrências com limit=0. Isso gera contagens e resumos agrupados sem baixar todos os registros.',
      p2: 'A consulta principal agrupa por mês, ano, conjunto de dados, reino e tipo de evidência. Consultas menores montam grupos candidatos de espécies, conservação e temas.',
      queryAria: 'Esboço da consulta resumida do GBIF',
      countFacets: 'contagem + facetas',
      arrow: 'facetas viram cartões',
      signals: ['Mês', 'Ano', 'Reino', 'Conjunto de dados', 'Tipo de evidência'],
    },
    species: {
      title: 'Como as espécies são selecionadas?',
      p1: 'As espécies em destaque vêm de grandes posições taxonômicas. Cada posição pede ao GBIF as espécies locais mais registradas nessa classe ou reino.',
      p2: 'Bee Around mantém um pequeno grupo principal, remove candidatos pouco representados e então usa a semente do pôster para escolher uma mistura repetível.',
      groups: ['Mamífero', 'Ave', 'Inseto', 'Planta com flor', 'Árvore ou samambaia', 'Fungo'],
      arrow: 'principais candidatos locais',
      boardAria: 'Esboço de seleção de posições de espécies',
      boardLabels: ['Ave', 'Inseto', 'Planta'],
    },
    labels: {
      title: 'O que significam os rótulos do pôster?',
      season: 'Na temporada - junho',
      seasonDescription: 'Gerado a partir das principais espécies registradas no mês calendário atual.',
      ...
      risk: 'Em risco - CR',
      riskDescription: 'Escolhido entre as principais espécies locais no maior grupo de risco IUCN disponível.',
      signature: 'Assinatura - 12x',
      signatureDescription: 'Escolhido entre espécies cuja participação local no GBIF é alta em relação à base global.',
    },
    photos: {
      title: 'Como as fotos são escolhidas?',
      p1: 'A identidade da espécie é escolhida primeiro a partir dos dados do GBIF. As imagens são uma camada de fallback de melhor esforço adicionada depois.',
      p2: 'As fontes são testadas por ordem de prioridade. Se nenhuma imagem resolver, a espécie permanece e o cartão usa um placeholder.',
      fallbackAria: 'Prioridade de fallback de fotos',
      steps: ['Correspondência exata do iNaturalist', 'Chave GBIF Wikidata / Commons', 'Mídia de espécie do GBIF'],
      firstMatchWins: 'primeira correspondência vence',
    },
    comparison: {
      title: 'Como a comparação funciona?',
      p1: 'Um notebook resolve cidades e países curados, depois consulta facetas do GBIF para cada caixa delimitadora.',
      p2: 'Ele calcula área, densidade de registros, proporção ameaçada e contagens de espécies únicas, então ranqueia linhas dentro de coortes de cidade ou país. O app leva o arquivo enxuto de percentis.',
      flowAria: 'Fluxo de pré-computação',
      flow: ['lugares', 'facetas', 'percentis'],
      barsAria: 'Barras de comparação de exemplo',
      recordingIntensity: 'Intensidade de registro',
      threatenedShare: 'Proporção ameaçada',
    },
    regenerate: {
      title: 'Por que Regenerar continua repetível?',
      p1: 'Todo pôster tem uma semente. Regenerar muda a semente, alternando candidatos principais elegíveis e posições de cartões desbloqueados.',
      p2: 'As espécies são deduplicadas entre cartões, e links compartilhados guardam lugar, semente, tema, idioma e bloqueios.',
      seed1: 'Semente 1',
      seed2: 'Semente 2',
    ...
    credits: {
      ...
      p: 'Nomes de espécies, taxonomia, contagens de ocorrência, metadados de conjuntos de dados e links de espécies do GBIF vêm do GBIF. Créditos e licenças de fotos aparecem quando a fonte da imagem os fornece.',
      dataAndAttribution: 'Dados e atribuição',
    },
  },
}
